...
export function getOrganizationConfig(organizationId) {
	return request({
		url: '/api/web/interconnection/organizationConfig/' + organizationId,
		method: 'get'
	})
}
...
export function saveAvailableStation(data) {
	return request({
		url: '/api/web/organization/saveAvailableStation',
		method: 'post',
		headers: {
			"Content-Type": "application/json; charset=UTF-8",
		},
...
export function getAvailableStation(organizationId) {
	return request({
		url: '/api/web/organization/getAvailableStation/' + organizationId,
		method: 'get'
	})
}