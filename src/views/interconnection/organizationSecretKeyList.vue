	...
	<div class="app-container">
		<div class="filter-container">
			...
			<div style="margin: 15px 0;">
				<el-button type="primary" @click="addOrUpdateHandle()" v-if="btnAuthen.permsVerifAuthention(':interconnection:secretKey:add')">添加</el-button>
			</div>
				...
				<el-table-column label="操作" align="center" width="310">
					<template slot-scope="scope">
						<div style="display: flex;justify-content: center;align-items: center;">
							<el-button type="primary" size = "mini" @click="chareStationPushHandle(scope.row)" 
							v-if="btnAuthen.permsVerifAuthention(':interconnection:organization:saveAvailableStation')">站点推送</el-button>
							<el-button type="primary" size = "mini" @click="addOrUpdateHandle(scope.row,false)"
							v-if="btnAuthen.permsVerifAuthention(':interconnection:secretKey:edit')">编辑</el-button>
							...
							v-if="btnAuthen.permsVerifAuthention(':interconnection:secretKey:delete')">删除</el-button>
						</div>
					</template>
				</el-table-column>
			</el-table>
