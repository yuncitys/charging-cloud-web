<template>
	<div class="app-container">
		<div class="filter-container">
			...
			<el-select style="width: 200px;margin-right: 20px ;" class="filter-item" v-model="listQuery.chargingStationIds" 
				multiple filterable clearable @change="handleFilter()" placeholder="请选择充电站">
				<el-option
		...
		data() {
			return {
				...
				listQuery: {
					...
					ruleId: 2,
          			chargingStationIds: '',
					devicePurpose: 'INTER_CONNECTION'
				},
				formThead: {
					deviceCode: true,
					deviceTypeName: true,
