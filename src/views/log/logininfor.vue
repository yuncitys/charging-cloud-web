<template>
	<div class="app-container">
      ...
      <el-select v-model="listQuery.status" style="width: 200px;margin-right: 20px ;" class="filter-item"
      	placeholder="登录状态" clearable @change="handleFilter">
      	<el-option v-for="item in tags" :key="item.id" :label="item.title" :value="item.id" />
			...
			<el-table v-loading="listLoading" :key="tableKey" :data="list" element-loading-text="拼命加载中......"  fit
				...
				<el-table-column prop="adminName" label="用户账号" align="center" :show-overflow-tooltip='isPc'>
				</el-table-column>
				<el-table-column prop="ipaddr" label="登录IP" align="center" :show-overflow-tooltip='isPc'>
				</el-table-column>
