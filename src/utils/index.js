...
export function numTime(end_time, now_time, str) {
  ...
  if (end_time < now_time) {
    ...
    if (str == 0) {
      let minutess = parseInt(days) * 60 * 60 + parseInt(hours * 60) + parseInt(minutes)
      // return hours +'小时'+minutes+ "分钟";
      return minutess + "分钟";
    } else {
      let hourss = parseInt(days) * 24 + parseInt(hours)
      return hourss + ":" + minutes + ":" + second;
    }
  }
}
//秒转时分秒
